...
function SidetabsPage(props) {

    const callChangeTheme = () =>{
       ...
       {/* <!-- end side-menu nav--> */}
        ...
        <div className="flex-lg-column d-none d-lg-block">
            <ul className="nav side-menu-nav justify-content-center">
                <li className="nav-item" onClick={callChangeTheme}>
                    <a className="nav-link light-dark-mode" href data-bs-toggle="tooltip" data-bs-placement="right" title="Dark / Light Mode">
...
export default connect(MapStateToProps,{ChangeTheme})(SidetabsPage)