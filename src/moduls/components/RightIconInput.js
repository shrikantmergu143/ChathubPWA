...
function RightIconInput(props) {
  return (
    <div className={`input-right-container ${props?.className}`}>
        <label htmlFor={props?.htmlFor} className="right-icon">
